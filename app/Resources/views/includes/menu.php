	...
	<div>
		<ul id="menu">
			<li <?php if($page=='Accueil'){echo 'class="active"';}
						elseif($page=='Participer'){echo 'class="active"';}?>><a href="?t=Accueil">Accueil</a></li>

			<li <?php if($page=='Presentation'){echo 'class="active"';}
						elseif($page=='Trophees'){echo 'class="active"';}?>><a href="?t=Presentation">Pr&eacute;sentation</a></li>
			<li <?php if($page=='Qui_sommes_nous'){echo 'class="active"';}?>><a href="?t=Qui_sommes_nous">Qui sommes-nous ?</a></li>
			...
			<li <?php if($page=='Partenaires'){echo 'class="active"';}?>><a href="?t=Partenaires">Partenaires</a></li>
			...
			<li <?php if($page=='Photos'){echo 'class="active"';}
						...
						elseif($page=='Charger_Photos'){echo 'class="active"';}?>><a href="?t=Photos">Photos</a></li>
			<li <?php if($page=='Contact'){echo 'class="active"';}
						...
						elseif($page=='Contact_Traitement'){echo 'class="active"';}?>><a href="?t=Contact">Contact</a></li>
...
?>
			...
			<li <?php if($page=='Profil'){echo 'class="active"';}
					...
					elseif($page=='Edit_Password'){echo 'class="active"';}?>><a href="?t=Profil">Profil</a></li>
...
?>
			<li <?php if($page=='Administration'){echo 'class="administration"';}
						elseif($page=='Equipe'){echo 'class="administration"';}?>><a href="?t=Administration">Administration</a></li>
<?php
			}
			else
			{
?>
			<li <?php if($page=='Mon_Equipe'){echo 'class="active"';}
						...
						elseif($page=='Edit_Equipe'){echo 'class="active"';}?>><a href="?t=Mon_Equipe">Mon &eacute;quipe</a></li>
<?php
			}
